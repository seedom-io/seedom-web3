...
var CauseLogo = function (_Component) {
  ...
  _createClass(CauseLogo, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'cause-logo ' + size, style: { backgroundImage: 'url(' + imageUrl + ')' } });
    }
  }]);
    ...
    value: function render() {
      ...
      if (router && router.location) {
        if (router.location.search !== '') {
          var query = new URLSearchParams(router.location.search.substr(1));
          var network = query.get('n');
          var contract = query.get('c');
          var participant = query.get('p');
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('meta', { name: 'twitter:site', content: '@seedom_io' }),
        ...
        _react2.default.createElement('meta', { name: 'twitter:image', content: finalImage }),
        _react2.default.createElement('meta', { name: 'twitter:url', content: finalUrl }),
        _react2.default.createElement('meta', { name: 'og:type', content: 'website' }),
        _react2.default.createElement('meta', { name: 'og:site_name', content: name }),
        ...
        _react2.default.createElement('meta', { name: 'og:image', content: finalImage }),
        _react2.default.createElement('meta', { name: 'og:url', content: finalUrl }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'division bottom medium-pad' },
            _react2.default.createElement(
              'div',
              { className: 'field' },
              _react2.default.createElement(
...
var Caster = function (_Component) {
  ...
  _createClass(Caster, [{
    ...
    value: function render() {
      var _props = this.props,
          caster = _props.caster,
          ended = _props.ended;

      var status = getStatus({ caster: caster, ended: ended });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'bit' },
            caster.votes.toString(),
            ' / ',
            caster.maxVotes.toString()
          )
        )
      );
    }
...
Caster.propTypes = {
  caster: _propTypes2.default.shape().isRequired,
...
var _score = __webpack_require__(/*! ../score */ "./app/components/vote/components/score/index.js");
...
var Index = function (_Component) {
  ...
  function Index(props) {
    ...
    _this.validateForm = function (done) {
      var isFormValid = _this.score.validate();
      _this.setState({ isFormValid: isFormValid }, done);
    };
    ...
    _this.handleSubmit = function () {
      _this.validateForm(function () {
        if (_this.state.isFormValid) {
          ...
          var score = _this.score.value();
          onVoteIndex({ index: cause.index, score: score });
        } else {
    ...
    _this.handleRemove = function () {
      var _this$props2 = _this.props,
          cause = _this$props2.cause,
          onVoteIndex = _this$props2.onVoteIndex;
    ...
    _this.getHeatmapColor = function () {
      var _this$props3 = _this.props,
          cause = _this$props3.cause,
          caster = _this$props3.caster;

      var value = cause.averageScore.div(caster.maxScore);
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var available = !ended && (vote || cause.caster === account || !caster.votes.isEqualTo(caster.maxVotes));

      var voted = vote && vote.isGreaterThan(0);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'bit begin header-normal stretch' },
            cause.name
          ),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'bit' },
            (0, _numbers.localeDecimal)(cause.averageScore)
          ),
          _react2.default.createElement(
            'div',
            { className: 'bit' },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'a',
                    { className: 'button is-white', disabled: isLoading, onClick: this.handleDone },
                    'done'
                  )
                )
              )
            ...
            voted && _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'a',
                    { className: 'button is-white', disabled: isLoading, onClick: this.handleRemove },
                    'unvote'
                  )
                )
              )
...
var Name = function (_Component) {
  ...
  function Name(props) {
    ...
    _this.validateForm = function (done) {
      ...
      var isScoreValid = _this.score.validate();
      _this.setState({
    ...
    _this.handleSubmit = function () {
      _this.validateForm(function () {
        ...
        if (isFormValid) {
          var score = _this.score.value();
          _this.props.onVoteName({ name: name, score: score });
        } else {
...
/***/ "./app/components/vote/components/score/index.js":
/*!*******************************************************!*\
  !*** ./app/components/vote/components/score/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.scss */ "./app/components/vote/components/score/index.scss");
...
var Score = function (_Component) {
  ...
  function Score(props) {
    ...
    _this.validate = function () {
      ...
      var isValid = value.isGreaterThanOrEqualTo(1) && value.isLessThanOrEqualTo(_this.props.maxScore);
      _this.setState({ isValid: isValid });
      return isValid;
    };
...
Score.propTypes = {
  ...
  disabled: _propTypes2.default.bool.isRequired,
  maxScore: _propTypes2.default.shape().isRequired
};
Score.defaultProps = {
  value: null
};
...
/***/ "./app/components/vote/components/score/index.scss":
/*!*********************************************************!*\
  !*** ./app/components/vote/components/score/index.scss ***!
  \*********************************************************/
/*! no static exports found */
...
var pollingMiddleware = function pollingMiddleware(store) {
  var handleCaster = function handleCaster(next, action) {
    return next({
      type: 'POLLING_CASTER',
...
exports.parseCastName = exports.parseCastIndex = exports.parseVotes = exports.parseCauses = exports.parseCaster = undefined;
...
var parseCaster = function parseCaster(caster) {
  return {
    maxScore: new _bignumber.BigNumber(caster._maxScore),
    maxVotes: new _bignumber.BigNumber(caster._maxVotes),
    votes: new _bignumber.BigNumber(caster._votes)
  };
};
...
var parseCauses = function parseCauses(causes) {
  ...
  for (var causeIndex = 0; causeIndex < causes._names.length; causeIndex += 1) {
    var parsedCause = {
      ...
      scores: new _bignumber.BigNumber(causes._scores[causeIndex]),
      votes: new _bignumber.BigNumber(causes._votes[causeIndex])
    };
    // calculate average score
    parsedCause.averageScore = parsedCause.votes.isGreaterThan(0) ? parsedCause.scores.div(parsedCause.votes) : (0, _numbers.zero)();
...
var parseVotes = function parseVotes(votes) {
  ...
  for (var voteIndex = 0; voteIndex < votes._causeIndexes.length; voteIndex += 1) {
    parsedVotes[votes._causeIndexes[voteIndex]] = new _bignumber.BigNumber(votes._scores[voteIndex]);
  }
  return parsedVotes;
};
...
var parseCastIndex = function parseCastIndex(castIndex) {
  return {
    ...
    score: new _bignumber.BigNumber(castIndex._score),
    votes: new _bignumber.BigNumber(castIndex._votes),
    causeIndex: new _bignumber.BigNumber(castIndex._causeIndex),
    causeScores: new _bignumber.BigNumber(castIndex._causeScores),
    causeVotes: new _bignumber.BigNumber(castIndex._causeVotes)
  };
};
...
var handleCaster = function handleCaster(prevState, action) {
  var newState = getNewState(prevState);
...
var handleCastIndex = function handleCastIndex(prevState, action) {
  ...
  var _action$castIndex = action.castIndex,
      ...
      score = _action$castIndex.score,
      votes = _action$castIndex.votes,
      causeIndex = _action$castIndex.causeIndex,
      causeScores = _action$castIndex.causeScores,
      causeVotes = _action$castIndex.causeVotes;
  ...
  cause.averageScore = causeVotes.isGreaterThan(0) ? causeScores.div(causeVotes) : (0, _numbers.zero)();
...
var render = function render(request, state) {
  var history = request ? (0, _createMemoryHistory2.default)({ initialEntries: [request.path] }) : (0, _createBrowserHistory2.default)();
...
var WebappWebpackPlugin = __webpack_require__(/*! webapp-webpack-plugin */ "webapp-webpack-plugin");
...
module.exports = {
  ...
  plugins: [new WebappWebpackPlugin({
    inject: true,
...
/*!****************************************!*\
  !*** external "webapp-webpack-plugin" ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("webapp-webpack-plugin");
